<template>
  <header class="bg-background-primary shadow-soft border-b border-border-light sticky top-0 z-50">
    <nav class="container mx-auto px-4">
      ...
      >
        <div v-if="isMobileMenuOpen" class="md:hidden pb-4 bg-background-tertiary rounded-b-lg">
